...
const navLeagues = [
    { slug: 'la-liga',               name: 'La Liga',          abbr: 'LAL', logo: '/storage/logos/leagues/la-liga.webp' },
    { slug: 'premier-league',        name: 'Premier League',   abbr: 'EPL', logo: '/storage/logos/leagues/premier-league.webp',        dark: true },
    { slug: 'uefa-champions-league', name: 'Champions League', abbr: 'UCL', logo: '/storage/logos/leagues/uefa-champions-league.webp', dark: true },
    { slug: 'ligue-1',               name: 'Ligue 1',          abbr: 'L1',  logo: '/storage/logos/leagues/ligue-1.webp' },
    { slug: 'bundesliga',            name: 'Bundesliga',       abbr: 'BUN', logo: '/storage/logos/leagues/bundesliga.webp' },
    { slug: 'serie-a',               name: 'Serie A',          abbr: 'SA',  logo: '/storage/logos/leagues/serie-a.webp',               dark: true },
...
const moreLeagues = [
    { slug: 'concacaf-champions-league', name: 'CONCACAF CL',        abbr: 'CCL', logo: '/storage/logos/leagues/concacaf-champions-league.webp' },
    { slug: 'major-league-soccer',       name: 'MLS',                abbr: 'MLS', logo: '/storage/logos/leagues/major-league-soccer.webp' },
    { slug: 'eredivisie',                name: 'Eredivisie',         abbr: 'ERE', logo: '/storage/logos/leagues/eredivisie.webp' },
    { slug: 'primeira-liga',             name: 'Primeira Liga',      abbr: 'PL',  logo: '/storage/logos/leagues/primeira-liga.webp' },
    { slug: 'copa-america',              name: 'Copa América',       abbr: 'CA',  logo: '/storage/logos/leagues/copa-america.webp' },
    { slug: 'euro-championship',         name: 'EURO',               abbr: 'EUR', logo: '/storage/logos/leagues/euro-championship.webp' },
    { slug: 'world-cup',                 name: 'World Cup',          abbr: 'WC',  logo: '/storage/logos/leagues/world-cup.webp' },
    { slug: 'championship',              name: 'Championship',       abbr: 'CH',  logo: '/storage/logos/leagues/championship.webp' },
    { slug: 'league-cup',               name: 'Carabao Cup',        abbr: 'CC',  logo: '/storage/logos/leagues/league-cup.webp' },
    { slug: 'fa-cup',                    name: 'FA Cup',             abbr: 'FA',  logo: '/storage/logos/leagues/fa-cup.webp' },
    { slug: 'coupe-de-france',           name: 'Coupe de France',    abbr: 'CDF', logo: '/storage/logos/leagues/coupe-de-france.webp' },
    { slug: 'copa-del-rey',              name: 'Copa del Rey',       abbr: 'CDR', logo: '/storage/logos/leagues/copa-del-rey.webp' },
    { slug: 'coppa-italia',              name: 'Coppa Italia',       abbr: 'CI',  logo: '/storage/logos/leagues/coppa-italia.webp' },
    { slug: 'uefa-nations-league',       name: 'UEFA Nations League',abbr: 'UNL', logo: '/storage/logos/leagues/uefa-nations-league.webp' },
    { slug: 'concacaf-gold-cup',         name: 'CONCACAF Gold Cup',  abbr: 'CGC', logo: '/storage/logos/leagues/concacaf-gold-cup.webp' },
    { slug: 'saudi-pro-league',          name: 'Saudi Pro League',   abbr: 'SPL', logo: '/storage/logos/leagues/saudi-pro-league.webp' },
]
...
.action-btn { width: 44px; height: 44px; border-radius: 50%; background: none; border: none; color: #ef4444; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.15s; }
...
.suggestions-label { font-size: 11px; font-weight: 700; color: #ef4444; text-transform: uppercase; letter-spacing: 0.6px; padding: 12px 16px 6px; border-left: 2px solid #ef4444; margin-left: 14px; }
...
.sug-avatar { width: 28px; height: 28px; border-radius: 50%; background: #1a1a1a; border: 0.5px solid #333; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 700; color: #fff; flex-shrink: 0; }
.sug-name { font-size: 14px; color: #fff; }
.sug-count { font-size: 12px; color: #a0a0a8; margin-left: auto; }
...
.mobile-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.65); z-index: 200; }
...
/* ── DRAWER ── */
.drawer-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.65); z-index: 200; }
...
.drawer-label { font-size: 11px; font-weight: 700; color: #ef4444; text-transform: uppercase; letter-spacing: 0.6px; padding: 0 20px 10px; border-left: 2px solid #ef4444; margin-left: 18px; }
...
.drawer-avatar span { font-size: 10px; font-weight: 700; color: #1a1a1a; }
.drawer-count { margin-left: auto; font-size: 12px; color: #c0c0d0; background: #1a1a1a; padding: 1px 7px; border-radius: 99px; }
...
.footer-team-avatar span { font-size: 9px; font-weight: 700; color: #aaa; }
