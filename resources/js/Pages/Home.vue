                    ...
                    >
                        <div class="thumb" :style="thumbBg(match)">
                            ...
                            <div class="thumb-teams">
                                <div class="fb-team">
                                    <div class="fb-logo">
                                        <img v-if="match.home_team?.logo_url" :src="match.home_team.logo_url" loading="lazy" :alt="teamName(match.home_team)" />
                                ...
                                <div class="fb-team">
                                    <div class="fb-logo">
                                        <img v-if="match.away_team?.logo_url" :src="match.away_team.logo_url" loading="lazy" :alt="teamName(match.away_team)" />
